            ...
            <li key={item.href}>
              <Link
                ...
                className={`transition-all duration-300 ${
                  isActive
                    ? "md:relative md:text-gray-900 md:bg-green-200/20 md:flex md:py-3 md:gap-x-2 md:text-lg md:pr-4 md:before:content-[''] md:before:absolute md:before:right-0 md:before:top-0 md:before:h-full md:before:w-1 md:before:bg-success md:before:rounded-md text-green-600"
                    : "md:text-gray-600 md:flex md:py-3 md:gap-x-2 md:text-lg md:pr-4 md:hover:bg-green-100/20 text-gray-600"
                }`}
              >
